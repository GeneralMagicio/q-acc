...
export const customButtonClass: HTMLAttributes<HTMLDivElement>['className'] =
  'font-redHatText min-w-[168px] min-h-[66px] px-10 py-6 flex justify-center items-center text-[white] md:text-sm font-bold bg-pink-500 rounded-full shadow-tabShadow text-xs cursor-pointer';
