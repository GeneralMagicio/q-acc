				...
				<div className='flex flex-col gap-8'>
					<div className='font-redHatText'>
						<p className='text-[#1D1E1F] text-xl'>
							All project owners and donors are required to verify
							their identity with our identity solution provider,
							Privado. You only need to do it once, and it
							shouldn&apos;t take long.
						</p>
					</div>
							...
							{verified.error ? (
								<>
									...
									<span className='text-[#C71D06] font-redHatText text-sm'>
										...
										please contact Qacc support team{' '}
										<b>qacc@giveth.io</b>
									</span>
								</>
							) : verified.isVerified ? (
								<>
									...
									<span className='text-[#1B8C82] font-redHatText text-sm'>
										You account has been successfully
										verified.
									</span>
								</>
							) : (
