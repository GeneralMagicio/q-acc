            ...
            {!verified.isVerified && !isLoading && (
              <>
                <div className='font-redHatText text-xl'>
                  ...
                  <ul className='list-disc px-10 leading-loose '>
                    ...
                    <li className='font-normal'>
                      ...
                      You are always in control of your data. Privado ID doesn’t
                      store your personal information, so the risk of data leaks
                      is eliminated.
                    </li>
                    <li className='font-normal'>
                      <strong className='font-bold'>Simplified UX: </strong>
                      With Privado ID’s web wallet and mobile app, you can
                      collect credentials like proof of humanity and proof of
                      residency easily.
                    </li>
                    <li className='font-normal'>
                      <strong className='font-bold'>
                ...
                <div className='bg-[#F7F7F9] flex flex-col  p-6 rounded-2xl'>
                  <div className='flex flex-col gap-4'>
                    <h6 className='text-[#1D1E1F] font-bold text-lg'>
                      2. After submitting, come back to this site in
                      approximately 24 hours and click “Check status with
                      Privado ID”.
                    </h6>
                  </div>
                </div>
                ...
                <p className='font-redHatText text-xl'>
                  Got stuck somewhere in the process? If you’re having trouble
                  or received an error, don’t hesitate to contact us at{' '}
                  <a
